...
const initState : IShopState = {
  products: [
      ...
      {id: 2, name: 'Гриль Кинг', description: 'Королевский, ммм',
      ...
      {id: 3, name: 'Воппер', description: 'Такой воздушный, ммм',
      ...
      {id: 4, name: 'Гамбургер', description: 'Такой доступный и вкусный, ммм',
      ...
      {id: 5, name: 'Чизбургер', description: 'Так много сыра и так доступно, ммм',
        img: 'https://burger-kingi.ru/images/menu-item/300/rodeo-gamburger.jpg',
        category: 'burgers', price: 65, count: 1, size: 'S'},
      {id: 6, name: 'Беконайзер', description: 'Так много мяса, и так жирно, ммм',
      ...
      {id: 7, name: 'Наггетсы', description: 'Такие хрустящие..',
      ...
      {id: 8, name: 'Картошка-Фри', description: 'Как у бабушки...',
      ...
      {id: 9, name: 'Луковые колечки', description: 'К пиву :)',
